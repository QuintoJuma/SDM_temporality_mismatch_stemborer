...
# Load data
# ----------------------------
r1 <- rast(raster1_path)  # Busseola fusca raster
r2 <- rast(raster2_path)  # Chilo partellus raster
...
# ----------------------------
vals_r1 <- terra::extract(r1, coords)[,2]  # values from Busseola raster
vals_r2 <- terra::extract(r2, coords)[,2]  # values from Chilo raster
